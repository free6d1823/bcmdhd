...
#if defined(N4_ENABLE_SET_BUS_TXGLOM)
...
#endif /* !defined(N4_ENABLE_SET_BUS_TXGLOM) */
dongle_glom_out:
	return err;
}
...
static s32 wl_dongle_filter(struct net_device *ndev, u32 filter_mode)
{
	...
	s8 buf[256];
	s32 err = 0;
	//nFore 20130808 fix pkt_filter_add re-entry error message
	static int nFilterAddCount = 0;
        //nFore 20130808 fix pkt_filter_add re-entry error message
	...
	memcpy((char *)pkt_filterp, &pkt_filter,
        ...
        //nFore 20130808 fix pkt_filter_add re-entry error message start
