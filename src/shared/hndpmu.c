...
static const sdiod_drive_str_t sdiod_drive_strength_tab6_1v8[] = {
	...
	{0, 0x0} };
//CJ test only
static const sdiod_drive_str_t sdiod_drive_strength_tab6_nfore[] = {
	{6, 0x6},
        {3, 0x3},
        {2, 0x2},
        {1, 0x1},
...
//	case SDIOD_DRVSTR_KEY(BCM4324_CHIP_ID, 17): //nFore 20130820 add BCM4324 support
		str_tab = (sdiod_drive_str_t *)&sdiod_drive_strength_tab6_1v8;
		str_mask = 0x00001800;
		str_shift = 11;
		break;
        case SDIOD_DRVSTR_KEY(BCM4324_CHIP_ID, 17): //nFore 20130820 add BCM4324 support
                 str_tab = (sdiod_drive_str_t *)&sdiod_drive_strength_tab6_nfore;
                str_mask = 0x00003800;
                str_shift = 11;
                break;
...
//CJ		PMU_MSG(("SDIO: %dmA drive strength requested; set to %dmA\n",
//		         drivestrength, str_tab[i].strength));
            pr_err("CJ:  SDIO: %dmA drive strength requested; set to %dmA\n",
                       drivestrength, str_tab[i].strength);
